...
#define SDAPORT	PORTD	//TAKE PORTB as SDA OUTPUT WRITE
#define SDADDR	DDRD	//TAKE PORTB as SDA INPUT configure

#define SCLPIN	PIND	//TAKE PORTD TO READ DATA
#define SDAPIN	PIND	//TAKE PORTB TO READ DATA

#define SCL	PD6		//PORTD.4 PIN AS SCL PIN, green wire
#define SDA	PD7		//PORTB.1 PIN AS SDA PIN, white wire
